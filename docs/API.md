...
Удаляет дубликаты из новых данных.
...
**Алгоритм:**
1. Проверка по ID организации
2. Проверка по координатам (радиус 50м)
3. Проверка схожести названий (95%+)

#### `calculateTitleSimilarity(title1, title2)`
Вычисляет схожесть названий (алгоритм Жаккара).

**Параметры:**
- `title1` (String) - первое название
- `title2` (String) - второе название

**Возвращает:** Number (0-1) - коэффициент схожести
